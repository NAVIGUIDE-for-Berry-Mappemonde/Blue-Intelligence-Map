...
from app.routers import amp, formalities, marinas, misc, ml, project_runs, projects, review, runs, swarm
...
for module in (project_runs, projects, swarm, marinas, formalities, amp, runs, review, ml, misc):
