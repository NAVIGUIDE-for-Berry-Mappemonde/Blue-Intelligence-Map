...
class TestFingerprint:
    def test_no_secrets_and_features(self, monkeypatch):
        ...
        assert fp["nvidia_model"] == "deepseek-ai/deepseek-v4-flash-0731"
        assert fp["nvidia_judge_chain"][0] == "deepseek-ai/deepseek-v4-flash-0731"
        ...
        assert fp["features"]["wpi_counterlist"] is True
        assert fp["git_sha"]
